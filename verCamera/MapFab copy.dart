...
class _MapFabScreenState extends State<MapFabScreen2> with SingleTickerProviderStateMixin {
        ...
        flush = Flushbar<bool>(
          ...
          mainButton: FlatButton(
            onPressed: () async {
              ...
              await navigator.push(MaterialPageRoute(builder: (context) => DetailScreenPage(markerID)));
            },
            child: Text(
              "More detail",
  ...
  BitmapDescriptor currentLocation_Icon, home_Icon, photo_spot_Icon, nightlife_Icon, sports_Icon, jetso_Icon, music_Icon, art_Icon, festival_Icon, food_Icon, film_Icon, kid_Icon, lohas_Icon, style_Icon, testing_Icon;

  Map<String, BitmapDescriptor> icon_list = Map();
  void _initialIcon() {
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 2.1), 'assets/currentLocation.png').then((d) {
      currentLocation_Icon = d;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 2.1), 'assets/home.png').then((d) {
      home_Icon = d;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/photo_spot.png').then((d) {
      photo_spot_Icon = d;
    ...
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/sports.png').then((d) {
      sports_Icon = d;
    ...
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/music.png').then((d) {
      music_Icon = d;
      icon_list['music'] = music_Icon;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/art.png').then((d) {
      art_Icon = d;
      icon_list['art'] = art_Icon;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/festival.png').then((d) {
      festival_Icon = d;
      icon_list['festival'] = festival_Icon;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/food.png').then((d) {
      food_Icon = d;
      icon_list['food&drink'] = food_Icon;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/film.png').then((d) {
      film_Icon = d;
      icon_list['film&TV'] = film_Icon;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/lohas.png').then((d) {
      kid_Icon = d;
    ...
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/style.png').then((d) {
      style_Icon = d;
      icon_list['style'] = style_Icon;
    });
    BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 1.5), 'assets/TestingMapPin.png').then((d) {
      testing_Icon = d;
  ...
  void _saveDataToSharedPreference() async {
    ...
    debugPrint('debug: saved new location to device' + screen_location.toString());
  }
  ...
  void _moveToSavedLocation() async {
    ...
    await mapController.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: home.position, zoom: 15.0)));
  }
  ...
  void _placeScreenMarker() async {
    var screenWidth = MediaQuery.of(context).size.width * MediaQuery.of(context).devicePixelRatio;
    var screenHeight = MediaQuery.of(context).size.height * MediaQuery.of(context).devicePixelRatio;
    ...
    screenMarker = Marker(
      ...
      onDragEnd: ((newPosition) {
        ...
        screenMarker = createMarkerFromLatLng('ScreenCenterMarker', newPosition);
      }),
...
//TODO: test with fixed value first
  Future<void> _addEvent(BuildContext context) async {
    if (screenMarker != null) {
      ...
      final navigator = Navigator.of(context);
      await navigator.push(MaterialPageRoute(builder: (context) => AddEventPage(screenMarker.position)));
    } else {
